package com.example.nguyenduy.projectbase.screen.main.architectureComponents.viewModel.activity.shareDataMultiFragment;
...
public class MasterFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_view_model_fragment_master, container, false);
    }
