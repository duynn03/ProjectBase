package com.example.nguyenduy.projectbase.base.view.coordinatorLayout;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    // AvatarImage is child view
    // Toolbar is dependency
    // method này sẽ tự động được kích hoạt khi scroll (do khi user scroll thì Toolbar cũng sẽ di chuyển theo)
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, CircleImageView child, View dependency) {
        return dependency instanceof Toolbar;
    }

    // bất cứ khi nào layoutDependsOn return về true thì method này sẽ được gọi
    // ==> ở đây sẽ implement animation cho child view
    @Override
